...
")
 ...
 '(package-selected-packages
   '(magit markdown-preview-mode markdown-mode hydra ivy doom-themes go-guru highlight-parentheses company-jedi company-go company go-mode diff-hl projectile nlinum solarized-theme solaire-mode flycheck dashboard doom-modeline neotree))
 '(prog-mode-hook
   '(company-mode flycheck-mode nlinum-mode flycheck-mode hl-line-mode))
 '(projectile-after-switch-project-hook '(neotree-show))
